      ...
      <AlertDialogContent>
        ...
        <div>
          <TsnSelectRemote
            ...
            onValueChange={e => setInvoiceLine({ ...invoiceLine, item: { ...invoiceLine.item, _id: e } })}
          />
          ...
          />
          <TsnInput title={t('Description')} defaultValue={invoiceLine.note} onBlur={e => setInvoiceLine({ ...invoiceLine, note: e.target.value })} />
